...
const logoVariants = cva(null, {
  variants: {
    ...
    size: {
      normal: 'w-[110px] h-[33px]',
      large: 'w-[200px] h-[59px]'
    },
    hideTextOnMobile: {
      true: '',
      false: ''
  ...
  compoundVariants: [
    {
      ...
      className:
        'w-[33px] h-[45px] pointer-events-none md:w-[110px] md:h-[33px] md:pointer-events-auto'
    },
    {
      size: 'large',
      hideTextOnMobile: true,
      className:
        'w-[58px] h-[45px] pointer-events-none md:w-[200px] md:h-[59px] md:pointer-events-auto'
    }
  ]
})
...
const Logo = ({
  ...
  return (
    ...
    >
      <svg
        data-test-id="logoSvg"
        className={cn({
          'h-[26px] md:h-auto': !!hideTextOnMobile && size === 'normal',
          'h-[45px] md:h-auto': !!hideTextOnMobile && size === 'large'
        })}
